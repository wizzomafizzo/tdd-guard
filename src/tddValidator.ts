...
export function tddValidator(
  ...
  const question =
    'Count the number of test() calls in the code. If there are 2 or more tests, respond with exactly the word "violation". If there is 1 or 0 tests, respond with exactly the word "ok".'
